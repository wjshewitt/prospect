    ...
    function initFormHandling() {
      ...
      form.addEventListener("submit", async function (e) {
        ...
        try {
          ...
          setTimeout(() => {
            showNotification(
              "Welcome to LandVision! Your account has been created successfully.",
              "success"
            );
      ...
      googleBtn.addEventListener("click", async function () {
        ...
        try {
          ...
          showNotification(
            "Google sign-in successful! Welcome to LandVision.",
            "success"
          );
      ...
      <div className="main-content">
        <div className="signup-container">
          ...
          <div className="signup-header">
            <h1 className="signup-title">Join LandVision Today</h1>
