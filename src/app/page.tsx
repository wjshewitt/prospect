    ...
    <div className="flex min-h-screen flex-col bg-c-off-white text-c-charcoal font-body">
      ...
      <header className="sticky top-0 z-50 bg-c-off-white/80 backdrop-blur-sm">
        <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
          <Link href="/" className="flex items-center gap-2">
            <svg
              className="h-8 w-8 text-c-green"
              fill="none"
              viewBox="0 0 48 48"
        ...
        <section className="container mx-auto grid grid-cols-1 items-center gap-12 px-4 py-20 md:grid-cols-2 md:px-6 lg:py-28">
          <div className="space-y-6">
            ...
            <p className="max-w-[600px] text-lg text-c-charcoal/80 md:text-xl">
              LandVision uses AI to help developers, planners, and architects
              analyze properties, generate site layouts, and visualize potential
              like never before.
            </p>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-4 text-lg text-c-charcoal/70">
                From initial assessment to detailed planning, LandVision
            ...
            <div className="mt-16 grid grid-cols-1 gap-12 md:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-c-charcoal/70">
                  Instantly generate and explore a high-fidelity 3D model of
                  your site's topography and proposed buildings.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-c-charcoal/70">
                  Automatically analyze elevation data to identify buildable
                  areas, steep slopes, and potential site constraints.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-c-charcoal/70">
                  Generate procedural building and solar panel layouts based on
                  your defined zones and density requirements.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="mb-6 h-48 w-full overflow-hidden rounded-lg shadow-md">
                  <Image
                    ...
                    alt="Drawing a boundary on a map"
                    width={400}
                    height={300}
                ...
                <p className="text-c-charcoal/70">
                  Use our intuitive drawing tools to outline the boundary of
              ...
              <div className="flex flex-col items-center text-center">
                <div className="mb-6 h-48 w-full overflow-hidden rounded-lg shadow-md">
                  <Image
                    ...
                    alt="A grid showing slope analysis on a map"
                    width={400}
                    height={300}
                    className="h-full w-full object-cover"
                    data-ai-hint="map analysis"
                  />
                </div>
                <h3 className="mb-2 text-xl font-bold">
                ...
                <p className="text-c-charcoal/70">
                  With one click, analyze the site's topography to understand
                  slopes, elevations, and buildable areas.
                </p>
              </div>
              ...
              <div className="flex flex-col items-center text-center">
                <div className="mb-6 h-48 w-full overflow-hidden rounded-lg shadow-md">
                  <Image
                    ...
                    alt="3D rendering of buildings on a landscape"
                    width={400}
                    height={300}
                    className="h-full w-full object-cover"
                ...
                <p className="text-c-charcoal/70">
                  Define development zones and let the AI generate building
                  layouts, then explore your project in a stunning 3D view.
                </p>
              </div>
            </div>
      ...
      <footer className="bg-white">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 py-8 md:flex-row md:px-6">
          <p className="text-sm text-c-charcoal/60">
            © {new Date().getFullYear()} LandVision. All rights reserved.
          </p>
          <div className="flex items-center gap-2">
            <svg
            ...
            <span className="text-lg font-semibold text-c-charcoal">
              LandVision
            </span>
          </div>
        </div>
